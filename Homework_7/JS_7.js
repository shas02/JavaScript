...
document.getElementById('submit').onclick = function () {
    if (document.getElementById('old').value < 18) {
        alert('Ти не пройдеш!')
    }
}
...
//     comentDiv.style.backgroundColor = '#86d608';
//     comentDiv.style.margin = '10px';
//
//     comentDiv.innerHTML = `
// <div>
//        title: ${coments[i].title} </div>
//        <button onclick="myFunction1()">Body:</button>
//        <div class = 'body'>${coments[i].body} </div>
// </div>`
